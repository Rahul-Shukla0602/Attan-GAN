...
class condGANTrainer(object):
    ...
    def build_models(self):
        ...
        state_dict = torch.load(img_encoder_path, map_location=torch.device('cpu'))
        ...
        epoch = 0
        if cfg.TRAIN.NET_G != '':
            state_dict = torch.load(cfg.TRAIN.NET_G, map_location=torch.device('cpu'))
            ...
            if cfg.TRAIN.B_NET_D:
                ...
                for i in range(len(netsD)):
                    ...
                    state_dict = torch.load(Dname, map_location=torch.device('cpu'))
