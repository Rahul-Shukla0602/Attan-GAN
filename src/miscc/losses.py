...
def words_loss(img_features, words_emb, labels,
    ...
    for i in range(batch_size):
        ...
        word = word.transpose(1, 2).contiguous() # ! tensor(14,cap_len,256),
        weiContext = weiContext.transpose(1, 2).contiguous() # ! tensor(14,cap_len,256),
        ...
        row_sim = cosine_similarity(word, weiContext) # ! tensor(14*cap_len) ,
